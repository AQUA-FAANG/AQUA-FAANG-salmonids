...
| [`transcriptome-analysis/`](transcriptome-analysis/) | RNA-seq clustering (SOMs/UMAP), GO enrichment, ortholog/ohnolog SOM co-clustering, and ohnolog/ortholog expression divergence (JSD). | Fig. 2a,c; 3; Ext. Data Figs. 4a,c, 5, 6; Suppl. Fig. 29; GO = Suppl. |
